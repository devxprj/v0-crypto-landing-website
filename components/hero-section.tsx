          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 items-center">
            ...
            <div className="flex justify-center items-center order-1 lg:order-2 mb-6 lg:mb-0">
              <div className="relative w-56 sm:w-72 lg:w-96 aspect-square">
                ...
                {/* Badges */}
                <div className="absolute -bottom-5 -right-5 bg-yellow-400 text-black font-black px-4 py-2 sm:px-6 sm:py-3 rounded-full border-4 border-black rotate-12 shadow-lg text-sm sm:text-lg">
                  100% DONATED
                </div>
                <div className="absolute -top-3 -right-6 bg-yellow-400 text-black font-black px-3 py-1 sm:px-5 sm:py-2 rounded-full border-4 border-black -rotate-12 shadow-lg text-xs sm:text-sm">
                  FOR THE KIDS
                </div>
              </div>
            </div>
            ...
            <div className="flex flex-col justify-center order-2 lg:order-1">
              <div className="mb-6 sm:mb-8">
                <h1 className="text-4xl sm:text-5xl lg:text-6xl font-black mb-3 sm:mb-4 text-center lg:text-left">
              ...
              <p className="text-base sm:text-lg text-foreground mb-6 sm:mb-8 leading-relaxed font-semibold max-w-full lg:max-w-lg text-center lg:text-left">
                Epstein financed 75% of Bitcoin. The code is compromised. We are reclaiming the narrative.
              </p>

              {/* Contract Address Box */}
              <div className="bg-white rounded-3xl border-4 border-secondary p-4 sm:p-6 mb-6 sm:mb-8 max-w-full lg:max-w-lg">
                <p className="text-xs font-bold text-secondary mb-1 sm:mb-2">CA:</p>
                <div className="flex items-center gap-2 sm:gap-3">
                  <code className="text-sm font-mono text-foreground truncate flex-1">
                    7p8hs6fZwTXvSYESCdHgWCXVsVcxTrX1cs3Q4yNGpu...
                  </code>
                  <button className="bg-secondary hover:bg-secondary/90 text-white font-bold py-1 sm:py-2 px-3 sm:px-4 rounded-full transition-colors text-xs sm:text-sm whitespace-nowrap">
                    COPY
                  </button>
                </div>
              </div>
              ...
              <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 justify-center lg:justify-start">
                ...
                >
                  <Button
                    size="lg"
                    className="w-full sm:w-auto bg-blue-600 hover:bg-blue-700 text-white font-bold rounded-full text-base sm:text-lg py-4 sm:py-6 px-6 sm:px-8"
                  >
                    BUY
                  </Button>
                </Link>
                ...
                >
                  <Button
                    size="lg"
                    className="w-full sm:w-auto bg-primary hover:bg-primary/90 text-white font-bold rounded-full text-base sm:text-lg py-4 sm:py-6 px-6 sm:px-8"
                  >
                    CHART
                  </Button>
                </Link>
